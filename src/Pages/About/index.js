    ...
    <div>
      ...
      <section class="text-gray-100 bg-gray-900 pt-5 lg:pt-28 h-screen body-font overflow-hidden">
        <div class="container px-5 py-0 lg:py-24 mx-auto flex justify-between flex-col-reverse lg:flex-row">
          <div class="pl-0 lg:pl-20 w-full lg:w-3/5 animate__animated animate__bounceInLeft py-0 lg:py-24">
            <h1 class="text-xl lg:text-4xl w-full lg:w-3/5 ">
          ...
          <div class="w-full lg:w-2/5 animate__animated animate__bounceInRight">
